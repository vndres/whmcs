        ...
        <div class="glass rounded-2xl border border-slate-800 p-5 sm:p-6 space-y-6">
            <form action="{{ route('profile.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                type="email"
                                value="{{ $client->email }}"
                                class="w-full rounded-xl bg-slate-900/60 border border-slate-800 px-3 py-2 text-sm text-slate-400"
                                disabled
                            >
                ...
                <div>
                    ...
                    <select
                        name="language"
                        class="w-full sm:w-64 rounded-xl bg-slate-900/60 border border-slate-700 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"
                    >
                        @php
                            $lang = old('language', $client->language ?? 'es');
                        @endphp
